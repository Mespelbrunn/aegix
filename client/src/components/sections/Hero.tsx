        ...
        <div className="max-w-4xl">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-10 leading-relaxed">
              We bridge the gap between strategy and results. We solve the execution problem by applying battle-proven military principles and experience to transform your organization's culture, leadership and operations.
            </p>
